...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.list_items.setGeometry(QtCore.QRect(40, 50, 521, 441))
        self.list_items.setObjectName("list_items")
        self.widget = QtWidgets.QWidget(self.centralwidget)
        self.widget.setGeometry(QtCore.QRect(600, 50, 181, 431))
        ...
        self.btn_rm = QtWidgets.QPushButton(self.widget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_rm.setText(_translate("MainWindow", "Remove"))
