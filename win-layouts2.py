...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        #v ve h layout oluşturma

        hlayout1 = QtWidgets.QHBoxLayout()    #horizantal
        ...
        hlayout2 = QtWidgets.QHBoxLayout()    #horizantal

        hlayout2.addWidget(Color("blue"))
        hlayout2.addWidget(Color("yellow"))
        hlayout2.setSpacing(50)

        #hlayoutları vlayout içerisini aktarıyoruz
